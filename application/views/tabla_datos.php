        ...
        <tbody>
          ...
          <?php
            ...
            /*  Body Modal  */
              ...
              echo              '<a class="nav-link" id="nav-semana-tab'.$user['id'].'" data-bs-toggle="tab" href="#nav-semana'.$user['id'].'" role="tab" aria-controls="nav-semana" aria-selected="false">Semana</a>';
              ...
              echo                '<canvas class="border border-2" name="chart" id="myChart'.$user['id'].'" width="50" height="50"></canvas>';
              echo              '</div>';
              echo            '</div>';
